...
| `ds-table-row-groups-bar` | Custom | No Material equivalent — bar between toolbar and header; drag target for row group columns + removable chips + Comfort/Compact density toggle; bind `[api]` to auto-sync; emits `(densityChange)` |
